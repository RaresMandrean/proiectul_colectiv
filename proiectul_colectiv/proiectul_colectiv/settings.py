"""
Django settings for proiectul_colectiv project.
...
SECRET_KEY = 'i07++d@+)yqa(8g6*a8!j8b(s5&4+n(etf!%7h3&vx74(hg_1*'
...
ROOT_URLCONF = 'proiectul_colectiv.urls'
...
WSGI_APPLICATION = 'proiectul_colectiv.wsgi.application'
...
LOGIN_REDIRECT_URL = 'eventix-home'
LOGIN_URL = 'login'
